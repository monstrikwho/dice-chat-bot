...
module.exports.outMoney = async (
  ...
  await bot.telegram.sendMessage(
    userId,
    `Aşağıdaki tutar bakiyenizden düşüldü: ${amount + commission} TL`
  );
  ...
  await axios
    ...
    .catch(async (err) => {
      ...
      await bot.telegram.sendMessage(
        userId,
        `Kesilen tutarın iadesi: ${amount + commission} TL`
      );

      return await bot.telegram.sendMessage(
        userId,
        `Lütfen sorunu çözmek için girilen verilerin doğruluğunu kontrol edin veya destek ekibimiz ile iletişime geçin.
