...
module.exports = (state) => {
  ...
  return Extra.markup((m) =>
    m.inlineKeyboard([
      ...
      [
        inlineBtnHook(m, `1️⃣  -  💰 ${state.rate[1]}  [x10]`),
        inlineBtnHook(m, `2️⃣  -  💰 ${state.rate[2]}  [x10]`),
      ],
      [
        inlineBtnHook(m, `3️⃣  -  💰 ${state.rate[3]}  [x10]`),
        inlineBtnHook(m, `4️⃣  -  💰 ${state.rate[4]}  [x10]`),
      ],
      [
        inlineBtnHook(m, `5️⃣  -  💰 ${state.rate[5]}  [x10]`),
        inlineBtnHook(m, `6️⃣  -  💰 ${state.rate[6]}  [x10]`),
      ],
      [
        inlineBtnHook(m, `Нечетное  -  💰 ${state.rate["odd"]}  [x3]`),
        inlineBtnHook(m, `Четное  -  💰 ${state.rate["even"]}  [x3]`),
      ],
      [inlineBtnHook(m, `1️⃣ - 2️⃣   -   💰 ${state.rate["1-2"]}  [x5]`)],
