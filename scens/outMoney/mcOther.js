...
// *************************** STEP 1 *******************************************
const mcOther = new Scene("mcOther");
mcOther.enter(async (ctx) => {
...
mcOther.on("text", async (ctx) => {
  ...
  return await axios
    .post(`https://edge.qiwi.com/sinap/providers/21012/onlineCommission`, {
      account: "79206020622",
      paymentMethod: {
        type: "Account",
        accountId: "643",
  ...
  await axios
    .post(`https://edge.qiwi.com/sinap/api/v2/terms/21012/payments`, obj)
